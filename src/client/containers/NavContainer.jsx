...
const mapDispatchToProps = (dispatch) => ({
  getResources: (tech_name, flag) => {
    dispatch(actions.getResource(tech_name, flag));
...
function NavContainer(props) {
  //const [wantedTopic, setWantedTopic] = useState('');
  ...
  // useEffect(() => {
  //   props.getResources(wantedTopic);
  // }, [wantedTopic]);
          ...
          {props.topics.map((topic) => {
            return (
              <NavItem
                ...
                // setWantedTopic={setWantedTopic}
                // wantedTopic={wantedTopic}
              />
            );
          })}
        </List>
